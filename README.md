...
1. **Material Collection**
    ...
    * **Best Practice: 10+ diverse recordings covering different topics.**  (Min. 5–6 for a base model).      This variety is crucial for capturing the person's natural rhythm, emotional baseline, and authentic persona accuracy.
...
## 💡 Best Practices for High-Precision Cloning

To achieve maximum fidelity and avoid AI hallucinations, please follow this workflow:

1.  **Use Step 2 as a Custom Prompt:**
    Load the `step2-MET-Knowledge-Construction-Prompt-v4.2-SAMPLE.md` into your LLM (e.g., Gemini 1.5 Pro) as a system instruction or initial prompt.
2.  **One File at a Time:**
    **Never upload 5–6 files at once.** Batch processing causes the AI to confuse speakers and context, leading to hallucinations. Analyze **one audio/transcript file at a time.**
3.  **Cumulative Knowledge Base:**
    Create a single text document (e.g., `my-knowledge-base.md`). For each analysis result generated by the AI, **append** the output to this document.
4.  **Increasing Precision:**
    As you append more results, the AI gains a higher-resolution understanding of subconscious patterns. Following the **Best Practice of 10+ diverse conversations** is strongly recommended to ensure a stable and high-fidelity "Thinking OS" reconstruction.
